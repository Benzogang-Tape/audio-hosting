...
const (
	...
	SongsService_UploadRawSongImage_FullMethodName = "/api.SongsService/UploadRawCover"
...
func (UnimplementedSongsServiceServer) UploadRawSongImage(grpc.ClientStreamingServer[UploadRawSongImageRequest, UploadRawSongImageResponse]) error {
	return status.Errorf(codes.Unimplemented, "method UploadRawCover not implemented")
}
...
var SongsService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/clients/songs/service.proto",
}
